...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f59e0b; color: white; padding: 20px; text-align: center;">
        <h1 style="margin: 0;">License Expiring Soon</h1>
    </div>
    ...
    <div style="background-color: #f9fafb; padding: 20px; margin-top: 20px;">
        ...
        <p>Your license for <strong>{{ $product->name }}</strong> will expire in <strong>{{ $daysUntilExpiration }} {{ $daysUntilExpiration === 1 ? 'day' : 'days' }}</strong>.</p>
        ...
        <p style="margin-top: 30px;">Please renew your license to continue using the product without interruption.</p>
